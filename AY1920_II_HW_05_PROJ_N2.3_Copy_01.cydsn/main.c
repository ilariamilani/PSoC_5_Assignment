...
int main(void)
{
    ...
    int16_t OutY_mg;
    int16_t OutZ_mg;
    uint8_t OutArray_mg[8]; 
    OutArray_mg[0] = header;
    OutArray_mg[7] = footer;
    ...
    // if new data is available:
            ...
            if(error == NO_ERROR)
        {
            ...
            OutX_mg = ((int16)((Data[0] | (Data[1]<<8)))>>6)*4/128; // 4 mg/digit --> *4/16
            ...
            if(error == NO_ERROR)
        {
            ...
            OutY_mg = ((int16)((Data[2] | (Data[3]<<8)))>>6)*4/128; // 4 mg/digit --> *4/16
            ...
            if(error == NO_ERROR)
        {
            ...
            OutZ_mg = ((int16)((Data[4] | (Data[5]<<8)))>>6)*4/128; // 4 mg/digit --> *4/16
            OutArray_mg[5] = (uint8_t)(OutZ_mg & 0xFF);
            OutArray_mg[6] = (uint8_t)(OutZ_mg >> 8);
        }
        }

        UART_Debug_PutArray(OutArray_mg, 8);
